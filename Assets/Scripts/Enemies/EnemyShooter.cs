...
public class EnemyShooter : MonoBehaviour
{
    ...
    void Update()
    {
        if (player != null)
        {
            ...
            if (closestHouse != null)
            {
                ...
                // Si est� dentro del rango de disparo, dispara
    ...
    void StopMovement()
    {
        // No se necesita hacer nada aqu� ya que solo dejamos de mover el enemigo
    }

    // M�todo que dispara balas hacia el objetivo
    void Shoot(Transform target)
    {
        ...
        // A�ade fuerza a la bala (suponiendo que tiene un Rigidbody2D)
        bullet.GetComponent<Rigidbody2D>().linearVelocity = direction * bulletSpeed; // Usa la velocidad definida
    }
